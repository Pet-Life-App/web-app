<div class="login">
    <nav class="topnav navbar navbar-expand shadow justify-content-between justify-content-sm-start navbar-dark bg-teal"
        id="sidenavAccordion">
        <!-- Sidenav Toggle Button-->
        <button class="btn btn-icon order-1 order-lg-0 me-2 ms-lg-2 me-lg-0 shadow-none" id="sidebarToggle"><i
        ...
        <ul class="navbar-nav align-items-center ms-auto">
            ...
            <li class="nav-item dropdown no-caret d-none d-sm-block me-3 dropdown-notifications">
                ...
                <div class="dropdown-menu dropdown-menu-end border-0 shadow animated--fade-in-up"
                    ...
                    <h6 class="bg-teal dropdown-header dropdown-notifications-header">
