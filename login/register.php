                                    ...
                                    <form>
                                        ...
                                        <div class="row gx-3">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="mb-3">
                                                    <label class="small mb-1" for="inputtown">City</label>
                                                    <input class="form-control" id="inputtown" type="City" placeholder="Enter Your City">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <a class="btn btn-teal btn-block" href="auth-login-basic.html">Create Account</a>
                                        </div>
                                    </form>
                                </div>
                                <div class="card-footer text-center">
                                    <div class="small"><a class="text-teal" href="/login">Have an account? Go to login</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
